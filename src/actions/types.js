...
export const TOGGLE_ASNAP = 'toggle_asnap'
...
export const LEAVE_CRUISE_FORM = 'leave_updagte_cruise_form'
...
export const LEAVE_LOWERING_FORM = 'leave_updagte_lowering_form'

  ...
  <Provider store={store}>
    <ConnectedRouter history={history}>
      ...
      <Switch>
        ...
        <Route path="/cruise_menu" exact={true} component={CruiseMenu} />
        <Route path="/lowerings" exact={true} component={RequireAuth(Lowerings)} />
        <Route path="/lowering_gallery/:id" exact={true} component={LoweringGallery} />
        <Route path="/lowering_map/:id" exact={true} component={LoweringMap} />
        <Route path="/lowering_replay/:id" exact={true} component={LoweringReplay} />
